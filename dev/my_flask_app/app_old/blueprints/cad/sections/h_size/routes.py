...
from app.config import H_STEEL_SIZES_BY_GROUP, h_steel_r_mapping as steel_r_mapping
...
bp = Blueprint("h_size", __name__, url_prefix="/h_size", template_folder="templates")
