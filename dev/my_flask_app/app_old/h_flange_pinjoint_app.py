...
h_flange_pinjoint_bp = Blueprint(
    "h_flange_pinjoint", __name__, template_folder="templates/h_flange_pinjoint"
)
...
@h_flange_pinjoint_bp.route("/", methods=["GET", "POST"])
def index():
    filenames = [
        "JW_OPT1.DAT",
        "JW_OPT1B.DAT",
    ...
    if request.method == "POST":
        ...
        steel_size_filtered = [v for i, v in enumerate(steel_size_vals) if i not in (0, 3)]
